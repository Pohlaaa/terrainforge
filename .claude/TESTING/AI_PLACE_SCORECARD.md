...
Generated: 2026-05-01T21:01:09.181Z

**Mean accuracy (operational entries only):** 66.7% (10/15 elements across 10 operational fixtures)
...
| 04-commercial-strip-mall | Commercial parking lot redesign | manual | 2/2 | 100% | ok |
| 05-recently-built-sparse | Recently-built / sparse imagery | placeholder | 0/1 | _skipped_ | — |
| 06-heavily-treed | Heavily-treed lot | manual | 1/2 | 50% | ok |
...
| 14-flat-suburban-baseline | Generic flat suburban (regression baseline) | manual | 1/2 | 50% | ok |
...
- `edging`: outside all 1 zone; nearest "around geocode point" is 93 ft past its boundary
...
- `firepit`: outside all 2 zones; nearest "near west patio" is 27 ft past its boundary

### 14-flat-suburban-baseline — Generic flat suburban (regression baseline)
- `walkway`: outside all 1 zone; nearest "front frontage" is 90 ft past its boundary
